        ...
        items = {
            ...
            items = {
                ...
                },
                {
                    ...
                    icon = 'radio',
                    type = 'client',
                    event = 'qb-radialmenu:radio:frequencies',
                    shouldClose = true,
                },
            }
            }, {
            ...
            items = {
                {
                    ...
                    id = 'vcreatekey',
                    title = 'Create Vehicle Key',
                    icon = 'plus',
                    type = 'client',
                    event = 'vehicle-keys:radial:CreateKey',
                    shouldClose = true
                }
            }
            }
        ...
        items = {
            {
                ...
                icon = 'music',
                type = 'client',
                event = 'anim-menu:openCategory',
                shouldClose = true,
                data = { category = 'Dances' }
            }, {
            id = 'anim_gestures',
            title = 'Gestures',
            icon = 'hand-peace',
