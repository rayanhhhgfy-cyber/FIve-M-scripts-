...
-- ============================================
-- AUTOMATICALLY ADDED MISSING RESOURCE TABLES
-- ============================================
...
CREATE TABLE IF NOT EXISTS evidence_analysis (
  ...
  analysed_by VARCHAR(50) DEFAULT NULL,
  created_at TIMESTAMP DEFAULT CURRENT_TIMESTAMP,
  INDEX idx_ea_case (case_id)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;

CREATE TABLE IF NOT EXISTS tow_missions (
  id INT AUTO_INCREMENT PRIMARY KEY,
...
CREATE TABLE IF NOT EXISTS winery_shifts (
  id INT AUTO_INCREMENT PRIMARY KEY,
  citizenid VARCHAR(50) NOT NULL,
  bottles_produced INT DEFAULT 0,
...
CREATE TABLE IF NOT EXISTS jail_records (
  ...
  jailed_by VARCHAR(50) NOT NULL,
  released TINYINT(1) DEFAULT 0,
  created_at TIMESTAMP DEFAULT CURRENT_TIMESTAMP,
  INDEX idx_jr_cid (citizenid)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;

CREATE TABLE IF NOT EXISTS wiretap_transcripts (
  id INT AUTO_INCREMENT PRIMARY KEY,
  wiretap_id INT NOT NULL,
  speaker VARCHAR(50) DEFAULT NULL,
  message TEXT NOT NULL,
  created_at TIMESTAMP DEFAULT CURRENT_TIMESTAMP
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;

CREATE TABLE IF NOT EXISTS lumberjack_tree_state (
  tree_id VARCHAR(50) NOT NULL PRIMARY KEY,
  chopped TINYINT(1) DEFAULT 0,
  respawn_time TIMESTAMP NULL DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;

CREATE TABLE IF NOT EXISTS hotdog_sales (
  id INT AUTO_INCREMENT PRIMARY KEY,
  citizenid VARCHAR(50) NOT NULL,
...
CREATE TABLE IF NOT EXISTS money_laundry_logs (
  id INT AUTO_INCREMENT PRIMARY KEY,
  citizenid VARCHAR(50) NOT NULL,
  dirty_amount INT NOT NULL,
  clean_amount INT NOT NULL,
  created_at TIMESTAMP DEFAULT CURRENT_TIMESTAMP
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;

CREATE TABLE IF NOT EXISTS card_skimmers (
  id INT AUTO_INCREMENT PRIMARY KEY,
...
CREATE TABLE IF NOT EXISTS card_fraud_logs (
  id INT AUTO_INCREMENT PRIMARY KEY,
  citizenid VARCHAR(50) NOT NULL,
...
CREATE TABLE IF NOT EXISTS wiretap_recordings (
  id INT AUTO_INCREMENT PRIMARY KEY,
  wiretap_id INT NOT NULL,
...
CREATE TABLE IF NOT EXISTS wiretap_warrants (
  id INT AUTO_INCREMENT PRIMARY KEY,
...
CREATE TABLE IF NOT EXISTS meth_lab_state (
  lab_id VARCHAR(50) NOT NULL PRIMARY KEY,
...
CREATE TABLE IF NOT EXISTS crypto_transactions (
  ...
  crypto_type VARCHAR(20) DEFAULT 'QBIT',
  created_at TIMESTAMP DEFAULT CURRENT_TIMESTAMP
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;

CREATE TABLE IF NOT EXISTS crypto_flags (
  id INT AUTO_INCREMENT PRIMARY KEY,
...
CREATE TABLE IF NOT EXISTS weapon_crafting_logs (
  id INT AUTO_INCREMENT PRIMARY KEY,
  citizenid VARCHAR(50) NOT NULL,
...
CREATE TABLE IF NOT EXISTS cid_notebook (
  id INT AUTO_INCREMENT PRIMARY KEY,
...
CREATE TABLE IF NOT EXISTS bus_logs (
  id INT AUTO_INCREMENT PRIMARY KEY,
  citizenid VARCHAR(50) NOT NULL,
  passengers_transported INT DEFAULT 0,
  payout INT DEFAULT 0,
  created_at TIMESTAMP DEFAULT CURRENT_TIMESTAMP
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
CREATE TABLE IF NOT EXISTS property_listings (
  ...
  price INT NOT NULL,
  realtor_cid VARCHAR(50) NOT NULL,
...
CREATE TABLE IF NOT EXISTS crypto_tracked_wallets (
  wallet VARCHAR(100) NOT NULL PRIMARY KEY,
  tracked_by VARCHAR(50) NOT NULL,
  created_at TIMESTAMP DEFAULT CURRENT_TIMESTAMP
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
CREATE TABLE IF NOT EXISTS hotdog_shifts (
  id INT AUTO_INCREMENT PRIMARY KEY,
  citizenid VARCHAR(50) NOT NULL,
...
CREATE TABLE IF NOT EXISTS tow_logs (
  id INT AUTO_INCREMENT PRIMARY KEY,
  citizenid VARCHAR(50) NOT NULL,
  plate VARCHAR(20) NOT NULL,
...
CREATE TABLE IF NOT EXISTS winery_sales (
  id INT AUTO_INCREMENT PRIMARY KEY,
  citizenid VARCHAR(50) NOT NULL,
  amount INT DEFAULT 0,
  earnings INT DEFAULT 0,
...
CREATE TABLE IF NOT EXISTS news_broadcasts (
  id INT AUTO_INCREMENT PRIMARY KEY,
  reporter_cid VARCHAR(50) NOT NULL,
  title VARCHAR(100) NOT NULL,
  content TEXT NOT NULL,
  created_at TIMESTAMP DEFAULT CURRENT_TIMESTAMP
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
CREATE TABLE IF NOT EXISTS winery_production (
  id INT AUTO_INCREMENT PRIMARY KEY,
  citizenid VARCHAR(50) NOT NULL,
...
CREATE TABLE IF NOT EXISTS lumberjack_shifts (
  id INT AUTO_INCREMENT PRIMARY KEY,
  citizenid VARCHAR(50) NOT NULL,
  logs_harvested INT DEFAULT 0,
  payout INT DEFAULT 0,
  created_at TIMESTAMP DEFAULT CURRENT_TIMESTAMP
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
CREATE TABLE IF NOT EXISTS taxi_shifts (
  id INT AUTO_INCREMENT PRIMARY KEY,
  citizenid VARCHAR(50) NOT NULL,
  fares_completed INT DEFAULT 0,
  earnings INT DEFAULT 0,
  created_at TIMESTAMP DEFAULT CURRENT_TIMESTAMP
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;

CREATE TABLE IF NOT EXISTS surveillance_footage (
  id INT AUTO_INCREMENT PRIMARY KEY,
...
CREATE TABLE IF NOT EXISTS prison_escape_attempts (
  id INT AUTO_INCREMENT PRIMARY KEY,
  citizenid VARCHAR(50) NOT NULL,
...
CREATE TABLE IF NOT EXISTS news_shifts (
  id INT AUTO_INCREMENT PRIMARY KEY,
  citizenid VARCHAR(50) NOT NULL,
...
CREATE TABLE IF NOT EXISTS fencing_logs (
  id INT AUTO_INCREMENT PRIMARY KEY,
  citizenid VARCHAR(50) NOT NULL,
...
CREATE TABLE IF NOT EXISTS hacking_logs (
  id INT AUTO_INCREMENT PRIMARY KEY,
  citizenid VARCHAR(50) NOT NULL,
...
CREATE TABLE IF NOT EXISTS flatbed_logs (
  id INT AUTO_INCREMENT PRIMARY KEY,
  citizenid VARCHAR(50) NOT NULL,
  plate VARCHAR(20) NOT NULL,
  payout INT DEFAULT 0,
...
CREATE TABLE IF NOT EXISTS police_spikestrips (
  id INT AUTO_INCREMENT PRIMARY KEY,
  officer_cid VARCHAR(50) NOT NULL,
  coords JSON NOT NULL,
  active TINYINT(1) DEFAULT 1,
...
CREATE TABLE IF NOT EXISTS fence_reputation (
  citizenid VARCHAR(50) NOT NULL PRIMARY KEY,
  rep INT DEFAULT 0,
  updated_at TIMESTAMP DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
CREATE TABLE IF NOT EXISTS notebook_shares (
  ...
  shared_with_cid VARCHAR(50) NOT NULL,
  created_at TIMESTAMP DEFAULT CURRENT_TIMESTAMP
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
CREATE TABLE IF NOT EXISTS meth_lab_cooks (
  ...
  cook_cid VARCHAR(50) NOT NULL,
  batch_quality INT DEFAULT 100,
  created_at TIMESTAMP DEFAULT CURRENT_TIMESTAMP
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;

CREATE TABLE IF NOT EXISTS turf_owners (
  turf_id VARCHAR(50) NOT NULL PRIMARY KEY,
  gang_name VARCHAR(50) NOT NULL,
